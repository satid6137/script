...
$users = $conn->query("SELECT id, username, role FROM user WHERE active = 1 ORDER BY id");
?>
<!DOCTYPE html>
<html>
...
<body class="bg-light">
  <div class="container mt-4" style="max-width: 900px;">
    ...
    <a href="inactive_users.php" class="btn btn-warning mb-4">🚫 ผู้ใช้ที่ถูกปิดการใช้งาน</a>
